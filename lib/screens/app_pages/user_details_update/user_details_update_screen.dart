                            ...
                            child: Column(
                                  ...
                                  Column(
                                      ...
                                      children: [
                                        SingleChildScrollView(
                                            ...
                                            child: Row(
                                                ...
                                                children: List.generate(
                                                    udCtrl.vehicles.length,
                                                    (index) {
                                                  return GestureDetector(
                                                      onTap: () {
                                                        udCtrl.selectedIndex =
                                                            index;
                                                        udCtrl
                                                            .notifyListeners();
                                                      },
                                                              ...
                                                              children: [
                                                                ...
                                                                Text(
                                                                    udCtrl
                                                                        ...
                                                                        .toString()
                                                                        .toUpperCase(),
                                                                    style: AppCss.lexendRegular13.textColor(udCtrl
                                                                                .selectedIndex ==
                                                                            index
                                                                        ? appTheme
                                                                            .darkText
                                        ...
                                        AuthCommonWidgets().textAndTextField(
                                            language(
                                                context, appFonts.userName),
                                            language(context,
                                                appFonts.enterUserName),
                                            context,
                                        ...
                                        AuthCommonWidgets().textAndTextField(
                                            ...
                                            language(context,
                                                appFonts.enterYourEmailId),
                                            context,
                                            controller: udCtrl.emailController),
                                        VSpace(Insets.i25),
                                        AuthCommonWidgets().textAndTextField(
                                            language(context,
                                                appFonts.vehicleNumber),
                                            language(context,
                                                appFonts.enterVehicleNumber),
                                            context,
                                            controller:
                                        ...
                                        AuthCommonWidgets().textAndTextField(
                                            language(
                                                context, appFonts.maximumSeats),
                                            language(context,
                                                appFonts.enterMaximumSeat),
                                            context,
                                            controller: udCtrl
                                ...
                                CommonButton(
                                        text: udCtrl.isLoading
                                            ? language(
                                                context, appFonts.updating)
                                            : language(
                                                context, appFonts.update),
                                    ...
                                    .marginOnly(
                                        bottom: Insets.i20, top: Insets.i10)
                              ]))));
          });
        });
  }
